...
(1,'TENIS 1', 10, 0, 1),(2, 'CAMISETA', 10, 0, 1),
...
SELECT P.CODIGO, P.NOME, P.ESTOQUE, P.ID_FORNECEDOR,
		F.NOME, F.CONTATO, F.TELEFONE, F.ID_FORNECEDOR
FROM PRODUTO P
FULL JOIN FORNECEDOR F ON P.ID_FORNECEDOR  = F.ID_FORNECEDOR
...
select * from PRODUTO, FORNECEDOR, VENDA
